...
export default function ContestDetailPage() {
  ...
  if (days > 0) {
    formattedCountdown = `${days}d ${String(hours).padStart(2, '0')}h ${String(minutes).padStart(2, '0')}m`;
  } else if (hours > 0) {
          ...
          <div className="overflow-hidden rounded-3xl border border-orange-500/10 bg-[#071226] shadow-2xl ">
            <div className="flex items-center justify-between border-b border-white/5 px-6 py-5">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-slate-100">Submission Status</h2>
              </div>
              {stats ? (
            ...
            <div>
              {/* Table Header */}
              <div className="grid grid-cols-[1.5fr_1fr] bg-white/5 px-6 py-5">
                <p className="text-sm font-bold uppercase tracking-[0.2em] text-orange-100/90">
                  Student Name
                </p>
                      ...
                      <div className="flex items-center gap-3">
                        {submitted ? (
                          <>
                            ...
                            <span className="text-2xl font-medium text-emerald-400">Submitted</span>
                          </>
                        ) : (
                          <>
                            ...
                            <span className="text-lg font-medium text-red-300">Not yet</span>
                          </>
                        )}
                      </div>
                    </div>
