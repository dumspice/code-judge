          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                <button type="button" className="text-sm font-medium text-slate-500 underline-offset-4 hover:text-slate-900 hover:underline">
      ...
      <div className="relative hidden lg:block lg:w-1/2">
        ...
        <div className="absolute bottom-12 left-12 right-12">
          <blockquote className="text-lg font-medium leading-relaxed text-white/90">
            &ldquo;Code Judge giúp tôi luyện tập thuật toán hiệu quả hơn bao giờ hết.
            Hệ thống chấm bài nhanh, chính xác và trực quan.&rdquo;
          </blockquote>
